...
// this setting will ensure that queries will not automatically convert a stringID to an ObjectId for the sphereId field.
...
export class SphereKeys extends AddTimestamps(BaseEntity) {
