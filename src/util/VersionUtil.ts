...
export const VersionUtil = {
  ...
  getHighestForAllHardwareVersionsForAllUsers: function(data : Bootloader[] | Firmware[]) {
   ...
   * @returns {{}}
   */
  getHighestForAllHardwareVersions: function(data : Bootloader[] | Firmware[], releaseLevel: number) {
    let result = {};
  ...
  getHighestWithHardwareVersionSupport: function(data : Bootloader[] | Firmware[], dataMaps : any, hardwareVersion: string, releaseLevel: number) {
    let highest = null;
